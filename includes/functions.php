...
function my_custom_login_logo() {
    echo '<style type="text/css">
        ...
        h1 a { background-image:url('.get_bloginfo('template_directory').'/imag/logo/logo_edsm_admin.png) !important; background-size:320px 67px !important; width:320px !important; height:67px !important;}
    </style>';
}
...
//=================================================================== WORDPRESS WIDGETS// 
    function edsm_widgets_init() {
		register_sidebar(array(
            'name' => __('Sidebar General', 'edsm'),
            'description' => __('Sidebar general sitio web', 'edsm'),
            'id' => 'sidebar-general',
            'before_title' => '<h2>',
            'after_title' => '</h2>',
            'before_widget' => '',
    ...
    add_action('widgets_init', 'edsm_widgets_init');
//
?>